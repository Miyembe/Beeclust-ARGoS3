...
#ifndef BEECLUST_PROXIMITY_DEFAULT_SENSOR_H
#define BEECLUST_PROXIMITY_DEFAULT_SENSOR_H

#include <string>
#include <map>

namespace argos {
   class CBeeClustProximityDefaultSensor;
...
namespace argos {
   ...
   public:
      ...
      CBeeClustProximityDefaultSensor();

      virtual ~CBeeClustProximityDefaultSensor() {}
