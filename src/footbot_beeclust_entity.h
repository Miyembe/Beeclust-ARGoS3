#ifndef FOOTBOT_BEECLUST_ENTITY_H
#define FOOTBOT_BEECLUST_ENTITY_H
...
namespace argos {
 ...
 class CFootBotBeeClustEntity : public CComposableEntity {
 ...
 CFootBotBeeClustEntity();

 CFootBotBeeClustEntity(const std::string& str_id,
 ...
 CBeeClustProximitySensorEquippedEntity* m_pcProximitySensorEquippedEntity;
