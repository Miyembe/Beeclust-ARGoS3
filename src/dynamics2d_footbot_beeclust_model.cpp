...
#include "dynamics2d_footbot_beeclust_model.h"
...
namespace argos {
 ...
 CDynamics2DFootBotBeeClustModel::CDynamics2DFootBotBeeClustModel(CDynamics2DEngine& c_engine,
 ...
 RegisterAnchorMethod<CDynamics2DFootBotBeeClustModel>(
 GetEmbodiedEntity().GetOriginAnchor(),
 &CDynamics2DFootBotBeeClustModel::UpdateOriginAnchor);
 RegisterAnchorMethod<CDynamics2DFootBotBeeClustModel>(
 GetEmbodiedEntity().GetAnchor("turret"),
 &CDynamics2DFootBotBeeClustModel::UpdateTurretAnchor);
 RegisterAnchorMethod<CDynamics2DFootBotBeeClustModel>(
 GetEmbodiedEntity().GetAnchor("perspective_camera"),
 &CDynamics2DFootBotBeeClustModel::UpdatePerspectiveCameraAnchor);
 ...
 CDynamics2DFootBotBeeClustModel::~CDynamics2DFootBotBeeClustModel() {
 delete m_pcGripper;
 ...
 void CDynamics2DFootBotBeeClustModel::MoveTo(const CVector3& c_position,
 ...
 void CDynamics2DFootBotBeeClustModel::Reset() {
 ...
 void CDynamics2DFootBotBeeClustModel::CalculateBoundingBox() {
 ...
 void CDynamics2DFootBotBeeClustModel::UpdateFromEntityStatus() {
 /* Do we want to move? */
 ...
 void CDynamics2DFootBotBeeClustModel::TurretPassiveToActive() {
 ...
 void CDynamics2DFootBotBeeClustModel::TurretActiveToPassive() {
 ...
 void CDynamics2DFootBotBeeClustModel::UpdateOriginAnchor(SAnchor& s_anchor) {
 ...
 void CDynamics2DFootBotBeeClustModel::UpdateTurretAnchor(SAnchor& s_anchor) {
 ...
 void CDynamics2DFootBotBeeClustModel::UpdatePerspectiveCameraAnchor(SAnchor& s_anchor) {
 ...
 REGISTER_STANDARD_DYNAMICS2D_OPERATIONS_ON_ENTITY(CFootBotBeeClustEntity, CDynamics2DFootBotBeeClustModel);
