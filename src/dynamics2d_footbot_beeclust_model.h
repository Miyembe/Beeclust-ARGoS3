...
#ifndef DYNAMICS2D_FOOTBOT_BEECLUST_MODEL_H
#define DYNAMICS2D_FOOTBOT_BEECLUST_MODEL_H
...
namespace argos {
 ...
 class CDynamics2DFootBotBeeClustModel : public CDynamics2DMultiBodyObjectModel {

 public:

 CDynamics2DFootBotBeeClustModel(CDynamics2DEngine& c_engine,
 CFootBotBeeClustEntity& c_entity);
 virtual ~CDynamics2DFootBotBeeClustModel();
 ...
 CFootBotBeeClustEntity& m_cFootBotEntity;
