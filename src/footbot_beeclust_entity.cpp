...
namespace argos {
 ...
 static const CRadians PROXIMITY_SENSOR_RING_SPACING_ANGLE = CRadians(3.0f*(ARGOS_PI)/4.0f);
...
//  static const Real PROXIMITY_SENSOR_RING_RANGE = 0.1f;
 ...
 CFootBotBeeClustEntity::CFootBotBeeClustEntity() :
 ...
 CFootBotBeeClustEntity::CFootBotBeeClustEntity(const std::string& str_id,
 ...
 *m_pcEmbodiedEntity,
 ...
 void CFootBotBeeClustEntity::Init(TConfigurationNode& t_tree) {
 try {
 /*
 * Init parent
 */
 ...
 *m_pcEmbodiedEntity,
 ...
 void CFootBotBeeClustEntity::Reset() {
...
#define UPDATE(COMPONENT) if(COMPONENT->IsEnabled()) COMPONENT->Update();
 ...
 void CFootBotBeeClustEntity::UpdateComponents() {
 ...
 REGISTER_ENTITY(CFootBotBeeClustEntity,
 "foot-bot-beeclust",
 ...
 REGISTER_STANDARD_SPACE_OPERATIONS_ON_COMPOSABLE(CFootBotBeeClustEntity);
