...
#ifndef FOOTBOT_BEECLUST_H
#define FOOTBOT_BEECLUST_H
 ...
 */
class CFootBotBeeClust : public CCI_Controller {
...
private:
   ...
   CCI_FootBotBeeClustProximitySensor* m_pcProximity;
