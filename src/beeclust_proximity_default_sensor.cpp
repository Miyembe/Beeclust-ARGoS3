...
namespace argos {
 ...
 CBeeClustProximityDefaultSensor::CBeeClustProximityDefaultSensor() :
 ...
 void CBeeClustProximityDefaultSensor::Update() {
 ...
 *m_pcEmbodiedEntity)) {
 ...
 void CBeeClustProximityDefaultSensor::Reset() {
 ...
 Real CBeeClustProximityDefaultSensor::CalculateReading(Real f_distance) {
 ...
 REGISTER_SENSOR(CBeeClustProximityDefaultSensor,
 "beeclust_proximity", "default",
