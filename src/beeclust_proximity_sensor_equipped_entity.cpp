...
namespace argos {
 ...
 CBeeClustProximitySensorEquippedEntity::SSensor::SSensor(const CVector3& c_offset,
 ...
 CBeeClustProximitySensorEquippedEntity::CBeeClustProximitySensorEquippedEntity(CComposableEntity* pc_parent) :
 CEntity(pc_parent) {
 Disable();
 }
 ...
 CBeeClustProximitySensorEquippedEntity::~CBeeClustProximitySensorEquippedEntity() {
 ...
 void CBeeClustProximitySensorEquippedEntity::Init(TConfigurationNode& t_tree) {
 try {
 /*
 ...
 * 1. the BeeClustProximitySensorEquippedEntity has a parent;
 ...
 */
 ...
 void CBeeClustProximitySensorEquippedEntity::Enable() {
 CEntity::Enable();
 ...
 void CBeeClustProximitySensorEquippedEntity::Disable() {
 CEntity::Disable();
 for(size_t i = 0; i < m_tSensors.size(); ++i) {
 ...
 void CBeeClustProximitySensorEquippedEntity::AddSensor(const CVector3& c_offset,
 const CVector3& c_direction,
 Real f_range,
 SAnchor& s_anchor) {
 ...
 void CBeeClustProximitySensorEquippedEntity::AddSensorRing(const CVector3& c_center,
 Real f_radius,
...
/****************************************/
 ...
 void CBeeClustProximitySensorEquippedEntity::AddSensorCustomRing(const CVector3& c_center,
 Real f_radius,
 const CRadians& c_start_angle,
 ...
 CRadians cSensorSpacing = c_spacing_angle / un_num_sensors;
 CRadians cAngle;
 CVector3 cOff, cDir;
 for(UInt32 i = 0; i < un_num_sensors; ++i) {
 cAngle = c_start_angle + i * cSensorSpacing;
 ...
 void CBeeClustProximitySensorEquippedEntity::AddSensorFan(const CVector3& c_center,
 Real f_radius,
 const CRadians& c_start_angle,
 ...
 REGISTER_STANDARD_SPACE_OPERATIONS_ON_ENTITY(CBeeClustProximitySensorEquippedEntity);
